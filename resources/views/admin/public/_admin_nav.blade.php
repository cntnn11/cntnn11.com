	...
	<div class="navbar-inner">
		...
		<div class="navbar-brand">
			<a href="dashboard-1.html" class="logo">
				<img src="{{ ADMINCDN('assets/images/logo-white-bg@2x.png') }}" width="80" alt="" class="hidden-xs" />
				<img src="{{ ADMINCDN('assets/images/logo@2x.png') }}" width="80" alt="" class="visible-xs" />
			</a>
		...
		<ul class="nav nav-userinfo navbar-right">
			...
			<li class="dropdown user-profile">
				<a href="#" data-toggle="dropdown">
					<img src="{{ ADMINCDN('assets/images/user-1.png') }}" alt="user-image" class="img-circle img-inline userpic-32" width="28" />
					<span>
						Arlind Nushi
